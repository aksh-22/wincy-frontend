...
function ViewInvoice(props) {
  ...
  useEffect(() => {
    if (data) {
      ...
      setAmountDetails({
        ...
        balanceDue:
          Number(data?.finalAmount || 0) - Number(data?.paidAmount || 0),
      });
    }
  }, [data]);
  ...
  return isError ? (
    ...
    >
      <Loading loadingType={"spinner"} backgroundColor={"#FFF"} size={32} />
    </div>
  ) : (
    <>
      <div className="view_invoice_container" ref={ref}>
        <div className="d_flex my-3">
          <div className="flex">
            ...
            <img src={CompanyLogo} alt="noImage" className="companyLogo mt-3" />
          </div>
                ...
                {({ blob, url, loading, error }) =>
                  loading ? (
                    ...
                    <CustomButton
                      ...
                      className={"view_invoice_container_button"}
                    >
        ...
        <div className="d_flex invoice_details">
          <div className="flex">
            ...
            <p className="font20">
              Invoice Date:{dateCondition(data?.raisedOn, "DD MMM YYYY")}
            </p>
            <p className="font20">
              Due Date:{dateCondition(data?.dueDate, "DD MMM YYYY")}
            </p>
          </div>
        ...
        <div>
            ...
            <tbody>
              {data?.services?.map((item) => (
                <tr className="" key={item?._id}>
                  <td className="service_details_row">{item?.description}</td>
                  <td className="service_details_row">{item?.quantity}</td>
              ...
              <div className="my-4">
                ...
                <div className="invoice_transaction_header_row">
                  <div className="d_flex">
                    <div style={{ width: 10 }} />
                    <p style={{ marginLeft: 10 }}>Payment Date</p>
                  </div>
                  <p>Gateway</p>
                  <p>Amount</p>
                  <p>Gateway Fees</p>
          ...
          <div className="">
            ...
            <div className="invoiceFooter">
              <div style={{ flex: 0.5 }}>
                <div className="alignCenter invoiceFooter_left">
                  <p className="mr-5">Tax</p>
                  <p>
                    {currencySymbol(data?.currency)}
                    {amountDetails?.tax?.toFixed(2)}
                  </p>
                </div>
              </div>
              <div className="alignCenter invoiceFooter_right flex">
