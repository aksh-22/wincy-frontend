            ...
            <Page size='A4' style={styles.page}>
                <View style={styles.sectionOne}>
                    <View style={[styles.rowCenter, styles.mb20]}>
                        ...
                        <View>
                            <Text style={{ color: '#232e38', fontSize: 24 }}>
                                INVOICE
                            </Text>
                            <Text
                                style={[
                  ...
                  // color: "#000",
                    ...
                    >
                      {item?.customer?.email ?? ""}
                        ...
                        >
                            <View
                                style={[styles.rowCenter, { marginLeft: 30 }]}
                            >
                                <Text
                                    style={[
                                        styles.companyAddress,
              ...
              >
                        ...
                        {item?.services?.map((_item) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {_item?.paymentPhaseId?.description}
                                    </Text>
                                </View>
                                {/* <Text
                                    style={{
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flex: 1 }}>
                        {item?.noteForClient ? (
                            <View
                                style={[styles.companyAddress, { fontSize: 9 }]}
                            >
                                <Text
                                    style={[
                                        styles.headingText,
                        ...
                        <View style={[styles.rowCenter, styles.amountRow]}>
                            ...
                            {item.taxes.map((el, i) => (
                                <React.Fragment key={i}>
                                    ...
                                    >
                                        {currencySymbol(item?.currency)}
                                        {Number(el?.taxedAmount)?.toFixed(2)}
                                    </Text>
                                </React.Fragment>
                            ))}
                        </View>
