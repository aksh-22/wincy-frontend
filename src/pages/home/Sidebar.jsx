  ...
  return (
    <div className={`${classes.root} drawer_container`}>
              ...
              <>
                ...
                >
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <LightTooltip
                      arrow
                      title={user?.name?.length > 20 ? user?.name : ""}
                    >
                      <p
                        style={{
                          flex: 1,
                        ...
                        {userType?.userType && (
                          <>
                            ...
                            <span
                              ...
                              className={ProfilePopupCss.textEllipse}
                            >
                              {userType?.userType}
                            </span>
                            )
                  ...
                  <LightTooltip
                    arrow
                    title={
                      selectedOrg?.name?.length > 24 ? selectedOrg?.name : ""
                    }
                  >
                    <p
        ...
        <div className={classes.toolbar}>
          <div style={{ flex: 1 }}>
            ...
            >
              ...
              <p
                className="ralewayThinIta1lic"
                style={{ color: "#aaa", fontSize: 10, marginTop: 5 }}
              >
                &nbsp; Beta 0.3.5
              </p>
        ...
        >
          <LightTooltip title="Projects" arrow placement="right">
            <ListItem
              ...
              className={`${
                selectedListItem === 0 ? "activeIconColor" : "inActiveIconColor"
              } `}
            >
              <ListItemIcon>
                {/* <InboxIcon /> */}
          ...
          <LightTooltip title="Marketing Projects" arrow placement="right">
            <ListItem
              button
              onClick={() => handleSelectedItem(8)}
              className={`${
                selectedListItem === 8 ? "activeIconColor" : "inActiveIconColor"
              } `}
            >
              <ListItemIcon>
                {/* <InboxIcon /> */}
          ...
          {userType.userType && (
            <>
              ...
              {["Admin", "Member++", "Member"].includes(userType?.userType) && (
                <LightTooltip title="Teams" arrow placement="right">
                  <ListItem
                    button
              ...
              {(userType?.userType === "Admin" ||
                ...
                <LightTooltip title="Salary Calculator" arrow placement="right">
                  <ListItem
                    button
              ...
              {(userType.userType === "Admin" ||
                ...
                <LightTooltip title="Leads" arrow placement="right">
                  <ListItem
                    button
              ...
              <LightTooltip title="Announcement" arrow placement="right">
                <ListItem
                  button
              ...
              <LightTooltip title="Calender" arrow placement="right">
                <ListItem
                  button
          ...
          {(["Admin"].includes(userType?.userType) ||
            ...
            <>
              <LightTooltip title="Invoice" arrow placement="right">
                <ListItem
                  button
                  onClick={() => handleSelectedItem(5)}
                  className={`${
                    selectedListItem === 5 ||
                    (selectedListItem > 5 && selectedListItem < 6)
                      ? "activeIconColor"
                      : "inActiveIconColor"
                  } `}
                >
              ...
              {["Admin"].includes(userType?.userType) ? (
                <Collapse in={open} timeout="auto" unmountOnExit>
                  ...
                  >
                    <ListItem
                      button
                      onClick={() => handleSelectedItem(5.1)}
                      className={` ${
                    ...
                    <ListItem
                      button
                      onClick={() => handleSelectedItem(5.2)}
                      className={` ${
                    ...
                    <ListItem
                      button
                      onClick={() => handleSelectedItem(5.3)}
                      className={`${
      ...
      <main className={classes.content}>
          ...
          !props?.location?.pathname.includes("invoice") && (
            <div className="d_flex alignCenter px-2 pt-2">
              <HomeOutlinedIcon
                ...
                style={{ fontSize: 16, color: "var(--red)", cursor: "pointer" }}
              />
              <p
                style={{
                  fontSize: 14,
              ...
              >
                ...
                {props?.location?.pathname.includes("projects") && (
                  <span
                    className="rootHover"
                    onClick={() => history.push("/main/projects")}
                  >
                    Projects
                  </span>
                )}
                {props?.location?.pathname.includes("mywork") && (
                  <span
                    className="rootHover"
                    onClick={() => history.push("/main/mywork")}
                  >
                    My Work
                  </span>
                )}
                {(props?.location?.pathname.includes("myTeam") ||
                  props?.location?.pathname.includes("UserProfile")) && (
                  <span
                    className="rootHover"
                    onClick={() => history.push("/main/myTeam")}
                  >
                    My Team
                  </span>
                )}
                {props?.location?.pathname.includes("myLead") && (
                  <span
                    className="rootHover"
                    onClick={() => history.push("/main/myLeads")}
                  >
                    My Leads
                  </span>
                )}
                {props?.location?.pathname.includes("addLead") && (
                  <span
                    className="rootHover"
                    onClick={() => history.push("/main/myLeads")}
                  >
                ...
                {props?.location?.pathname.includes("myCalender") && (
                  <span
                    className="rootHover"
                    onClick={() => history.push("/main/myCalender")}
                  >
                    My Calender
                  </span>
                )}
                {props?.location?.pathname.includes("calculation") && (
                  <span
                    className="rootHover"
                    onClick={() => history.push("/main/calculation")}
                  >
                    Salary Calculator
                  </span>
                )}
                {props?.location?.pathname.includes("myProfile") && (
                  <span
                    className="rootHover"
                    onClick={() => history.push("/main/myProfile")}
                  >
                    My Profile
                  </span>
                )}
                {props?.location?.pathname.includes("announcement") && (
                  <span
                    className="rootHover"
                    onClick={() => history.push("/main/announcement")}
                  >
                    Announcement
                  </span>
                )}
                {props?.location?.pathname.includes("new_updates") && (
                  <span
                    className="rootHover"
        ...
        {
          props?.location?.pathname.includes("main/new_user") && <LandingPage />
          //  <div
        ...
        <Switch>
          ...
          <Route
            ...
            exact
            render={(props) => <Projects projectType="MARKETING" {...props} />}
          />
          ...
          <Route path="/main/UserProfile" component={UserProfile} exact />
          ...
          <Route path="/main/myCalender" component={MyCalendar} exact />
          <Route path="/main/calculation" component={SalaryCalculation} exact />
          <Route path="/main/announcement" component={Announcement} exact />
          <Route
          ...
          {(["Admin"].includes(userType?.userType) ||
            ...
            <>
              ...
              >
                <Route path="/main/invoice" component={Invoice} exact />
                {["Admin"].includes(userType?.userType) ? (
                  <>
                    {" "}
                    <Route
