...
export const getInvoiceNumber = (orgId, subsiduary) =>
    axiosInstance
        .get(`/invoices/bill/number/${orgId}/${subsiduary}`)
        .then((res) => res?.data);
...
export const createInvoice = ({ data, orgId, projectId }) =>
    axiosInstance
        .post(`/invoices/bill/create-invoice/${orgId}/${projectId}`, data)
        .then((res) => res?.data?.data);
...
export const updateInvoiceTransaction = ({ orgId, transactionId, data }) =>
    axiosInstance
        .patch(`/invoices/transaction/${orgId}/${transactionId}`, data)
        .then((res) => res?.data?.data);

export const updateInvoice = ({ orgId, projectId, invoiceId, data }) =>
    axiosInstance
        .patch(`/invoices/bill/${orgId}/${projectId}/${invoiceId}`, data)
        .then((res) => res?.data?.data);

export const fixInvoices = () =>
    axiosInstance.get(`/invoices/fix-invoice`).then((res) => res?.data);
